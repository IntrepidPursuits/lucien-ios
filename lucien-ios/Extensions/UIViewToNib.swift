...
public extension UIView {
    ...
    public class var ipNibName: String {
        let name = "\(self)".components(separatedBy: ".").first ?? ""
        return name
    }
    public class var ipNib: UINib? {
        if Bundle.main.path(forResource: ipNibName, ofType: "nib") != nil {
            return UINib(nibName: ipNibName, bundle: nil)
        } else {
            return nil
        }
    }
